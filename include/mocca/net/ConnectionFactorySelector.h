...
private:
    struct ProtocolMessageConnectionFactoryPair {
        std::string protocol;
        std::unique_ptr<IMessageConnectionFactory> factory;
    };
    struct ProtocolStreamConnectionFactoryPair {
        std::string protocol;
        std::unique_ptr<IStreamConnectionFactory> factory;
    };

    static std::vector<ProtocolMessageConnectionFactoryPair> messageConnectionFactories_;
    static std::vector<ProtocolStreamConnectionFactoryPair> streamConnectionFactories_;
};
}
}